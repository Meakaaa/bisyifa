...
<head>
  ...
  <section class="text-gray-600 body-font">
    <div class="container mx-auto flex px-10 py-24 md:flex-row flex-col items-center">
      <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
        <img class="object-cover object-center rounded" alt="banner" src="application/assets/img/banner.png">
      </div>
      ...
      <div class="flex flex-wrap -m-4">
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="application/assets/img/vaccine.jpg" alt="vaccine">
  ...
  <section class="text-gray-600 body-font bg-gray-100">
    <div class="container px-5 py-24 mx-auto">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-10 text-gray-900 text-center">Ketersediaan Bed</h1>
  ...
  <section class="text-gray-600 body-font">
    <div class="container px-10 py-24 mx-auto">
      ...
      <div class="flex flex-wrap -m-4">
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="application/assets/img/doctor.jpg" alt="doctor">
